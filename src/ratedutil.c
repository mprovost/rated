...
{
  debug(OFF, "[Polls = %llu] [DbInserts = %llu] [DbErrors = %llu] [DbOOR = %llu] [Zero = %u] [Wraps = %u] [Wraps64 = %u] [OBO = %u]\n",
      stats.polls, stats.db_inserts, stats.db_errors, stats.db_oor, stats.zero, stats.wraps, stats.wraps64, stats.obo);
